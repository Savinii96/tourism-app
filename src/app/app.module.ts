...
import { ViewAttComponent } from './components/view-att/view-att.component';
import { DetailsAttComponent } from './components/details-att/details-att.component';
...
const routes: Routes = [
  ...
  {
    path: 'attractions/all',
    component: ViewAttComponent

  },
  {
    path: 'attractions/:id',
    component: DetailsAttComponent
